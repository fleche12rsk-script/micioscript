...
local Window = OrionLib:MakeWindow({Name = "Micio Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Micio Hub"})
...
OrionLib:MakeNotification({
    Name = "Micio Hub",
    Content = "Por favor, espere  script carregar...,Não ative nenhuma função!",
    Image = "rbxassetid://119980140458596",
    Time = 5
})
...
local AttackList = {"-1", "0", "0.175", "0.2", "0.25", "0.3", "0.35", "0.4", "0.45", "0.5", "0.55", "0.6", "0.65", "0.7", "0.75", "0.8", "0.85", "0.9", "0.95", "0.1"}
M:AddDropdown({
